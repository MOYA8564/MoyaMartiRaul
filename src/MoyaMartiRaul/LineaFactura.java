package MoyaMartiRaul;
/**
 * 
 * @author WINDOWS-VIRTUAL
 *
 *@version 1.0 02/03/2015
 */
public class LineaFactura {
	/**
	 * Todos los parametros que utliza la clase
	 */
	...
	/**
	 * <p><strong>Devuelve el precio total de una linea</strong>. El precio de la unidad por la cantidad de productos 
	 * pedidos de esa uniad </p>
	 */
